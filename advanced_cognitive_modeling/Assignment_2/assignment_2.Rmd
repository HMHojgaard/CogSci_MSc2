...
### Plotting choice distribution for 500 trials. 
...
```
Plotting Beta distribution shapes for alpha prior
...
p_trace <- mcmc_trace(draws_df, pars = "tau_scaled") + 
  theme_classic() + 
  ggtitle("Trace Plot: Well-mixed chains tau_scaled")
...
p_trace <- mcmc_trace(draws_df, pars = "alpha") + 
  theme_classic() + 
  ggtitle("Trace Plot: Well-mixed chains alpha")
...
```{r}
# plotting the parameter revcovery MIGHT NEED ADJSUTMENT OF AXES
